                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="status" id="approve" value="2" <?php if($perpanjangan->status == 2) echo "selected"; ?> required>
                                        ...
                                        <div class="col">
                                            <div class="form-check">
                                                <input cl`ass="form-check-input" type="radio" name="status" id="reject" value="3" <?php if($perpanjangan->status == 3) echo "selected"; ?> required>
